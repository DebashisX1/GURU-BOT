...
function handler(m, { groupMetadata }) {
    ...
    m.reply(`*গোপন সূত্র থেকে পাওয়া ${toM(name)} চৌদ্দগুষ্টির বিবরণ:*\n
*বাবা:* Lord Samrat 😎\n
*মা/2nd বাবা:‌-* ${toM(b)}🫃\n
*ভাই/বোন:-* ${toM(c)}💆\n
*বর/বউ:-* ${toM(h)}👫\n
...
${toM(name)} এই হল তোমার আসল পরিচয়, কাল সবাইকে নিয়ে নবান্ন দেখা কর।🤸‍♂`, null, {
        mentions: [a, b, c, d, e, f, g, h, name] // Include all variables in mentions
    });
}
